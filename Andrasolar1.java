...
//Declaración de constantes *provisional* (se le tienen que pedir al usuario)
	...
	for (N=0; N<364; N++)
                ...
                delta[N][h] = (0.006918-0.399912*Math.cos(x[N][h])+0.070257*Math.sin(x[N][h])-0.006758*Math.cos(2*x[N][h])+0.000907*Math.sin(2*x[N][h])-0.002697*Math.cos(3*x[N][h])+0.001480*Math.sin(3*x[N][h]))*(180/pi);

		System.out.println(delta[N][h] + "me gusta el pene");
...
//                {
//                for (h=0; h<23; h++)
//                System.out.println((0.006918-0.399912*Math.cos(x[N][h])+0.070257*Math.sin(x[N][h])-0.006758*Math.cos(2*x[N][h])+0.000907*Math.sin(2*x[N][h])-0.002697*Math.cos(3*x[N][h])+0.001480*Math.sin(3*x[N][h]))*(180/pi));
//               }
//        }
